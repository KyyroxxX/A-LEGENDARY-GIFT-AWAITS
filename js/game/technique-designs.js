...
const BattleTechniqueDesigns = {
    ...
    KATANA_VARIANTS: {
        ...
        giyu: { water_slash: 'waterfall', flowing_dance: 'cross', striking_tide: 'spiral', water_dragon: 'crescent', calm_drop: 'iaido' },
        ...
        muichiro: { low_clouds: 'iaido', eight_layered: 'cross', sea_mist: 'serpent', moon_mist: 'crescent', mist_end: 'iaido' },
