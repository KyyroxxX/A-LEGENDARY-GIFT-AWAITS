...
const BattleData = {
    ...
    applyEnemyAffinityProfiles() {
        const profiles = {
            ...
            eren: { weak: ['fire', 'slash', 'bless'], resist: ['strike', 'curse'], null: [] },
            griffith: { weak: ['bless', 'fire', 'wind'], resist: ['curse', 'psy', 'strike'], null: [] },
            mob: { weak: ['curse', 'elec'], resist: ['psy', 'wind'], null: [] },
    ...
    musicFor(runKey) {
        ...
        const byEnemy = {
            ...
            quanxi: 'battle_chainsaw',
            asa: 'battle_chainsaw',
            katana: 'battle_chainsaw',
            kishibe: 'battle_chainsaw',
            kobeni: 'battle_chainsaw',
            ren: 'battle_persona',
            goro: 'battle_persona',
            ann: 'battle_persona',
            sumire: 'battle_persona',
            tae: 'battle_persona',
            futaba: 'battle_persona',
            makoto: 'battle_persona',
            strohl: 'battle_metaphor',
            heismay: 'battle_metaphor',
            junah: 'battle_metaphor',
            eupha: 'battle_metaphor',
            basilio: 'battle_metaphor',
            hualkenberg: 'battle_metaphor',
            marshall: 'battle_op',
            katakuri: 'battle_op',
            marco: 'battle_op',
            jinbe: 'battle_op',
            tobi: 'battle_akatsuki',
            tobirama: 'battle_akatsuki',
            konan: 'battle_akatsuki',
            kimimaro: 'battle_akatsuki',
            kakuzu: 'battle_akatsuki',
            jugo: 'battle_akatsuki',
            karin: 'battle_akatsuki',
            suigetsu: 'battle_akatsuki',
            kashimo: 'battle_jjk',
            meimei: 'battle_jjk',
            muzan: 'battle_kimetsu',
            yourichi: 'battle_kimetsu',
            genya: 'battle_kimetsu',
            shinobu: 'battle_kimetsu'
        };
        for (const id of ids) {
